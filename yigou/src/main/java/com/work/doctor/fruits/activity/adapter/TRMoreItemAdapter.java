...
public abstract class TRMoreItemAdapter<T> extends BaseQuickAdapter<T, BaseViewHolder> {
    /**
    ...
    public TRMoreItemAdapter(int code) {
        this(code, null);
    }
    public TRMoreItemAdapter(int code , @Nullable List<T> data) {
        super(data);
        this.code = code;
    }
