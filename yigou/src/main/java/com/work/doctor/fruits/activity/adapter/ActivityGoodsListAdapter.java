...
public class ActivityGoodsListAdapter extends TRecyclerAdapter<GoodsInfoBean> {


    public ActivityGoodsListAdapter(@Nullable List<GoodsInfoBean> data) {
        super(data);
    }
    ...
    protected int addItemLayoutRes() {
        return R.layout.item_activity_good;
    }
}
