...
public class SearchGoodsAdapter extends TRecyclerAdapter<GoodsInfoBean> {

    public SearchGoodsAdapter(@Nullable List<GoodsInfoBean> data) {
        super( data);
    }
    ...
    protected void convert(BaseViewHolder helper, GoodsInfoBean item) {
        ...
        helper.setText(R.id.item_shop_totalnumber, "月销量" + item.getSellTotalNum() + "件");
