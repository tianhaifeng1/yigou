...
public class TWeb2Fragment extends TInitFragment implements TWebJsConstraint {
...
//    private DemoModel demoModel;
    ...
    public static TWeb2Fragment newInstance(int code) {
        return new TWeb2Fragment(code);
    }

    public TWeb2Fragment(int code) {
        this.code = code;
    }
...
////            headInfoModel.setSign(getSignMD5String(reqToString));
////            HttpBase.headerInfo = gson.toJson(headInfoModel);
////
////            demoModel.postWebInfo();
//            initHtmlPath("https://www.baidu.com/", "");
//        }
